...
class Mouse:
    ...
    def get_button_value(self, button_name, button_up=False):
    ...
    def click(self, pos=(-1, -1), button_name="left"):
        ...
        self.move_mouse(pos)
        self._do_event(self.get_button_value(button_name, False)+self.get_button_value(button_name, True), 0, 0, 0, 0)
